<template>
  <div class="editor-container">
    <h2>TinyMCE Editor 1</h2>
    <p>This editor uses the original TinyMCE files from /vendor/tinymce/</p>
    <editor
        :init="editorConfig"
...
<script setup>
    ...
    window.editor1_openFileBrowser = () => {
      showFileBrowser.value = true;
    };

    window.editor1_setCallback = (callback) => {
